...
namespace DH_GUIClient
{
    ...
    public partial class ReturnBookWindow : Window
    {
        ...
        private const string CLIENT_FUNCTION = "return_book";

        public ReturnBookWindow(string ClientID)
        {
            InitializeComponent();
        ...
        private void DisplayResponseData(ResponseDTO data)
        {
            ...
            if (operationSuccess)
            {
                ...
                // Dispatcher.Invoke(() => ShowMessage($"{filteredLoanCollection.Count} filtered loans."));
        ...
        public void Members_Datagrid_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            ...
            if (selectedMember != null)
            {
                try
                {
                    ...
                    RequestDTO request = new RequestDTO(clientID, CLIENT_FUNCTION, acceptsCommandsFlag, acceptsMessagesFlag, RequestUseCase.RETURN_BOOK_UPDATE, false, memberId, -1, "");
        ...
        public void ReturnBook_Click(object sender, RoutedEventArgs e)
        {
        ...
        public void DoReturnBook()
        {
            try
            {
                RequestDTO request = new RequestDTO(clientID, CLIENT_FUNCTION, acceptsCommandsFlag, acceptsMessagesFlag, RequestUseCase.RETURN_BOOK, false, member_id, book_id, "");
                string requestString = client.serialiseRequestDTO(request);
                client.AddRequest(requestString);
            }
            catch (Exception e)
